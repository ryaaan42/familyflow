-- Update create_household_with_members to persist is_female for members.
-- The original function only stored is_pregnant, missing is_female introduced later.
...
begin
  ...
  loop
    ...
    values (
      ...
      10,
      v_index = 0,
      coalesce((v_member->>'isFemale')::boolean, false),
